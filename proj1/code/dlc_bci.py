...
def tensor_from_file(root, filename, base_url='https://documents.epfl.ch/users/f/fl/fleuret/www/data/bci'):
    """Build tensor from file."""
...
def load(root, train=True, download=True, one_khz=False):
    ...
    Args:
        ...
        one_khz (bool, optional): If True, creates dataset from the 1000Hz data
            instead of the default 100Hz.
